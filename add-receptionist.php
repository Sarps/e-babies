        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"class="active-menu"><i class="fa fa-sitemap"></i>Record Keeper<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-receptionist.php"class="active-menu">Add record keeper</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">Record Keeper</a></li>
                    <li class="active">Add Record Keeper member</li>
                </ol>
            ...
            <div class="container c1" style="margin-bottom: 120px;">
                ...
                <?php include('errors.php'); ?>  
                    <div class="form-group text-center heading1">
                        <h1>Add Record Keeper</h1>
                    </div>
                    <div class="form-group">
                        <label for="name">Record Keeper Name:</label>
                    ...
                    <button type="submit"name="reg_rec" class="button">Add Record Keeper</button>
                </form>
            </div>

            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="view-laboratory.php" class="active-menu">View All Laboratory</a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <div id="page-wrapper">
        <div class="header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">View Laboratory</li>
            </ol>
        ...
        <div class="container c1" style="margin-bottom: 120px;">
            ...
            <div class="form-group text-center heading1">
                <h1>View All Past Laboratory By Patient Name</h1>
            </div>
            ...
            <table class="table table-striped table-bordered text-centre">
                <thead>
                    ...
                    <th class="text-center">Diarrhoea</th>
                    <th class="text-center">Cholera</th>
                    <th class="text-center">HIV / AIDS</th>
                    <th class="text-center">Sickle Cells</th>
                </thead>
                <tbody id="response">
                </tbody>

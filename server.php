...
if (isset($_POST['save'])) {
    ...
    if ($uname == $name) {
        if ($new == $confirm) {
            ...
            array_push($errors, "your both password donot match");
        }
    } else {
...
if (isset($_POST['reg_time'])) {
    ...
    if (empty($start)) {
        array_push($errors, "Start shift time is required");
    }
    if (empty($end)) {
        array_push($errors, "End shift time is required");
    }
    if ($start == $end) {
...
if (isset($_POST['appoint'])) {
    ...
    if (empty($type)) {
        array_push($errors, "doctro name is required");
    }
    if (empty($day)) {
        array_push($errors, "day is required");
    }
